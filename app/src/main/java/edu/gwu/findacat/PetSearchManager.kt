...
import edu.gwu.findacat.petfinder.PetfinderResponse
...
class PetSearchManager(private val context: Context) {
    ...
    fun searchPets(location: Int) {
        ...
        apiEndpoint.findPets("0b1452a0af588b352bf732936fa8219b", "json", "cat", location).enqueue(object: Callback<PetfinderResponse> {
...
class PetSearchManager {
    ...
    fun searchPets() {
        ...
        apiEndpoint.findPets("514bbd950ff6b3da17cdb3ea4f0acb38", "json", "cat", 22102).enqueue(object: Callback<PetFinderResponse> {
            override fun onFailure(call: Call<PetFinderResponse>, t: Throwable) {
                Log.d(TAG, "API call failed!")
                petSearchCompletionListener?.petsNotLoaded()
            }
